...
\begin{abstract}
  ...
  Para lograr este objetivo se parte de la construcción de plantillas empleando la sintaxis de \emph{Jinja} y el motor de resolución de variablidad \emph{UVEngine} para generar el producto.
  ...
  El sistema se ha dividido en componentes para facilitar el mantenimiento del mismo. En , el esfuerzo realizado permite generar plantillas de ficheros de configuración con un alto grado de personalización
...
\bfseries{\large{Palabras clave:}} SPL, Docker, Despliegues Servicios, Desarrollo web, Configuración, feature models, Línea de Productos 

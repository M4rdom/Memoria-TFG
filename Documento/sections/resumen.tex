...
\begin{abstract}
  ...
  Para lograr este objetivo se parte de la construccion de plantillas empleando la sintaxis de jinja y el motor de resolucion de variablidad uvengine para generar el producto.
